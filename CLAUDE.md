...
- **ML pipeline**: GPR (sklearn) + BALD active learning + deterministic competitor/peer safety backstop + temperature-0 LLM qualification. Per-campaign models stored in `Campaign.model_blob` (DB).
